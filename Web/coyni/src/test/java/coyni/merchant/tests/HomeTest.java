...
//			 verify data presence
	...
	public void testcreateAccountPhoneVerification(String strParams) {
		try {
			...
			homePage.phoneVerificationComponent().authyComponent().fillAuthyInputInvalid(data.get("expCode"),
					data.get("Character"));
			if (!data.get("errMessage").isEmpty()) {
				Uninterruptibles.sleepUninterruptibly(500, TimeUnit.MILLISECONDS);
			...
			homePage.verifyCreateAccountPageHeading(data.get("createAccountHeading"));
			homePage.getPreviousData(data.get("firstName"), data.get("lastName"), data.get("phoneNumber"),
					data.get("email"), data.get("createPassword"), data.get("confirmPassword"));
			homePage.verifyClearAndUpdateAllFileds(data.get("firstName"), data.get("lastName"),
	...
	public void testcreateAccountEmailVerification(String strParams) {
		try {
			...
			homePage.phoneVerificationComponent().emailVerificationComponent().authyComponent()
