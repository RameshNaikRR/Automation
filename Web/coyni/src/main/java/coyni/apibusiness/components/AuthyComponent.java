...
public class AuthyComponent extends BrowserFunctions {
	...
	private By lblNewRegHeading = By.xpath("//div[text()='Phone Verification']");
	...
	private By lblNewRegAuthyDescription = By.xpath("//p[text()='We sent you a 6-digit code to the registered phone number']");
	...
	public void verifyNewRegPageHeading(String expHeading) {
		new CommonFunctions().verifyLabelText(lblNewRegHeading, "Autentication Heading", expHeading);
	}
	...
	public void verifyNewRegPageDescription(String expDescription) {
		new CommonFunctions().verifyLabelText(lblNewRegAuthyDescription, "Description ", expDescription);
	}
