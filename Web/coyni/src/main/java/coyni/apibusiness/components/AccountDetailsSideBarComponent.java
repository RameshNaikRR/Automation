...
import ilabs.WebFramework.BrowserFunctions;
	...
	public class AccountDetailsSideBarComponent extends BrowserFunctions {
		...
		private By getMenuItems(String elementName) {
			return By.xpath(String.format("//a//span[text()='%s']", elementName));
		}
		...
		public void clickPreferences() {
			click(getMenuItems("Preferences"), "preferences");
		}
		public void clickAgreements() {
			click(getMenuItems("Agreements"), "Agreements");
		}
		public void clickChangePassword() {
			click(getMenuItems("Change Password"), "Change Password");
		}
		public void clickTwoStepAuthentication() {
			click(getMenuItems("2-Step Authentication"), "2-Step Authentication");
		}
