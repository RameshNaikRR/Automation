...
import coyni.business.pages.AgreementsPage;
import coyni.business.pages.ChangePasswordPage;
import coyni.business.pages.PreferencesPage;
import coyni.business.pages.TwoStepAuthenticationPage;
...
public class TopBarDrpDwnComponent extends BrowserFunctions {
	...
	public void handSymbolHighlightedUserDetails(String cssProp, String expValue, String expColor) {
		...
		new CommonFunctions().verifyChangedColor(getDashBoardItems("Type"), "TopBarItems", cssProp, expValue, expColor);
	}
