...
public class AuthyComponent extends BrowserFunctions {
	...
	private By lblVerifyYourIdentityDescription = By
			.xpath("//h3[text()='Enter the code generated by your authentication app.']");
	...
	public void verifyYourIdentityHeading(String expHeading) {
		new CommonFunctions().verifyLabelText(lblVerifyYourIdentityHeading, "Verify Your Identity Page Heading",
				expHeading);
	}

	public void verifyYourIdentityDescription(String expDescription) {
		new CommonFunctions().verifyLabelText(lblVerifyYourIdentityDescription, "Verify Your Identity Page Description",
				expDescription);
	}
