...
import coyni.apibusiness.components.AddBeneficialOwnersComponent;
...
public class RegistrationBeneficialOwnersPage extends BrowserFunctions{
	...
	private By drpdwn = By.xpath("(//div[contains(@class,'BeneficialOwners_owners_wrap')]/details)[1]//div[contains(@class,'BeneficialOwners_accordion')]");
	...
	private By lnkUploadImg = By.xpath("(//div[contains(@class,'BeneficialOwners_owners_wrap')]/details)[1]//p[text()='Select Identification to Upload:']/../following-sibling::*[1]/input");
	...
	return	By.xpath(String.format("(//div[contains(@class,'BeneficialOwners_owners_wrap')]/details)[%s]//p[text()='Select Identification to Upload:']/../following-sibling::*[1]/input", num));
	}
	...
	public void verifyBeneficialOwnerDetails(String num,String expOwnerlabel,String ownerName,String ownerShipLabel,String ownerShipValue) {
...
//	  }
    ...
    public void validateBeneificalOwnersError(String expMsg,String elementName){
    	...
    	if(expMsg.equals(errormsg)) {
    		...
    		ExtentTestManager.setFailMessageInReport("Error Message "+errormsg+" is not displayed for "+elementName);
    	}
    	} 
