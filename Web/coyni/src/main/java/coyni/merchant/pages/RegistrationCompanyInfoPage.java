...
//	}
	...
	public void uploadDocument(String folderName,String fileName,String businessEntity) throws InterruptedException {
		...
		getElement(getUploadDocumentElement(num), "select Image"+i).sendKeys(FileHelper.getFilePath(folderName,fileName));
		Thread.sleep(3000);
		ExtentTestManager.setInfoMessageInReport("upload Image"+i);
	}
		}
		else {
			getElement(getUploadDocumentElement("1"), "select Image").sendKeys(FileHelper.getFilePath(folderName,fileName));
