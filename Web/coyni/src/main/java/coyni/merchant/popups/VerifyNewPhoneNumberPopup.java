...
public class VerifyNewPhoneNumberPopup extends BrowserFunctions {
	...
	private By lblresendErrorMsg = By
			.xpath("//span[contains(text(),'Looks like something went wrong. Please try again')]");
	private By lblNewPhoneNumberDescriptionText = By
