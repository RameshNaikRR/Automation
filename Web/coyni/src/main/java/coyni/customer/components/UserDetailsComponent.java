...
public class UserDetailsComponent extends BrowserFunctions {
    ...
    private By lblCurrentPhoneNumberDescriptionText = By.xpath("//span[@class='mt-8 text-base font-normal leading-5 tracking-tight text-center text-cgy4']");
    ...
    private By lblVerificationSuccesful = By.xpath("//span[@class='mt-1 text-sm text-center font-semibold text-cgn5 VerificationInput_code__verification_success__8qRYN']");
    ...
    private By lblNewPhoneNumberHeading = By.xpath("//h1[@class='text-cm3 tracking-normal Heading_heading1__18f6i mt-4 text-center']");
    private By headingEditPhoneNumber = By.xpath("//h1[@class='text-cm3 tracking-normal Heading_heading1__18f6i mt-4 text-center']");
...
public void verifyEditPhoneNumberAuthenticationDescription(String expEditPhoneNumberAuthenticationDescription) {
	new CommonFunctions().verifyLabelText(lblEditPhoneNumberAuthenticationDescription, "Edit Phone Number Description Text", expEditPhoneNumberAuthenticationDescription);
}
    ...
    public void verifyVerificationTextCodeBoxBorderColorWithInvalidCodeAndDescription(String expCode, String expColor ,String expVericationMsg ) {
    ...
    public void verifyVerifyCurrentPhoneNumberDescriptionText(String expVerifyPhoneNumberDescriptionText) {
    	new CommonFunctions().verifyLabelText(lblCurrentPhoneNumberDescriptionText, "Verify Current Phone Number Description Text", expVerifyPhoneNumberDescriptionText);
    ...
    public void verifyCurrentPhoneNumberVerificationCodeBorderColorAndDescriptionWithInvalidCode(String expColor, String expVerificationFailed) 
    {
    	new CommonFunctions().verifyTextBoxBorderColor(expColor);
    	new CommonFunctions().verifyLabelText(lblCurrentNumberVerificationFailed, "Verification Failed", expVerificationFailed);
    }
    ...
    public void verifyResendVerificationCodeDescription(String expResendVerificationCodeDescription) {
    	new CommonFunctions().verifyLabelText(lblResendVerificationCodeDescription, "Resend Verifiation Code Description", expResendVerificationCodeDescription);
    }
    ...
    public void verifyNewPhoneNumberVerificationCodeBorderColorAndDescription(String expCode,String expColor,String expVerificationSuccesfulMsg) {
    	...
    	new CommonFunctions().verifyTextBoxBorderColor(expColor);
    	new CommonFunctions().verifyLabelText(lblNewPhoneNumberVerificationSuccesful, "Verification Succesful", expVerificationSuccesfulMsg);
    ...
    public void verifyResendDescription(String expHeading) {
    	click(btnNewNumberResend,"Click Resend");
    	new CommonFunctions().verifyLabelText(lblNewPhoneNumberResendDescription, "New Phone Number Resend Verification", expHeading);
    }
    public void verifyResendDescriptionAppears() throws InterruptedException {
    	...
    	boolean flag = verifyElementPresence(lblNewPhoneNumberResendDescription, "Resend Verification Appears");
    			if(flag) {
    				...
    				ExtentTestManager.setFailMessageInReport("New Phone Number Resend Verification is not Appears Upto 3 seconds");
    	    	}
    			}
    public void verifyResendDescriptionDisappears() throws InterruptedException {
    	...
    	boolean flag = verifyElementPresence(lblNewPhoneNumberResendDescription, "Resend Verification Appears");
    			if(!flag) {
    				ExtentTestManager.setPassMessageInReport("New Phone Number Resend Verification is Disappers Upto 3 seconds");
    			} else {
    				ExtentTestManager.setFailMessageInReport("New Phone Number Resend Verification is not Disappers Upto 3 seconds");
    	    	}
    }
