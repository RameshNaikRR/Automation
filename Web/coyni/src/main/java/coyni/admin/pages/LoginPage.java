...
//	}
	...
	public void handSymbolHighlightedTransactions(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSideBarItems("Transactions"), "Transactions", cssProp, expValue,
				expColor);
	}
	...
	public void handSymbolHighlightedCoyniPortal(String cssProp, String expValue, String expColor) {
		...
		commonfunctions.verifyChangedColor(getSideBarItems("coyni Portal"), "coyni Portal", cssProp, expValue,
				expColor);
	}
	...
	public void handSymbolHighlightedUnderwriting(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSideBarItems("Underwriting"), "Underwriting", cssProp, expValue,
				expColor);
	}
	...
	public void handSymbolHighlightedReserveMgmt(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSideBarItems("Reserve Mgmt."), "Reserve Mgmt.", cssProp, expValue,
				expColor);
	}
	...
	public void handSymbolHighlightedGatewaySettings(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSideBarItems("Gateway Settings"), "Gateway Settings", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedExportedFiles(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSideBarItems("Exported Files"), "Exported Files", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedBalanceReports(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSideBarItems("Balance Reports"), "Balance Reports", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedSystemSettings(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSideBarItems("System Settings"), "System Settings", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedTokenAccount(String cssProp, String expValue, String expColor) {
		click(getSideBarItems("coyni Portal"), "coyni Portal");
		commonfunctions.verifyChangedColor(getSubMenuItems("Token Account"), "Token Account", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedCommissionAccount(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSubMenuItems("Commission Account"), "Commission Account", cssProp,
				expValue, expColor);
	}
	...
	public void handSymbolHighlightedCoyniEmployees(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSubMenuItems("coyni Employees"), "coyni Employees", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedAPIBusiness(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSubMenuItems("API Business"), "API Businesses", cssProp, expValue,
				expColor);
	}
	...
	public void handSymbolHighlightedTotalWithdraw(String cssProp, String expValue, String expColor) {
		...
		commonfunctions.verifyChangedColor(getSubMenuItems("Total Withdraw"), "Total Withdraw", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedTotalDeposits(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSubMenuItems("Total Deposits"), "Total Deposits", cssProp, expValue,
				expColor);
	}
	...
	public void handSymbolHighlightedPaymentGateways(String cssProp, String expValue, String expColor) {
		...
		commonfunctions.verifyChangedColor(getSubMenuItems("Payment Gateways"), "Payment Gateways", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedLoadBalancer(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSubMenuItems("Load Balancer"), "Load Balancer", cssProp, expValue,
				expColor);
	}
	...
	public void handSymbolHighlightedFeeStructure(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSubMenuItems("Fee Structure"), "Fee Structure", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedAccountLimits(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSubMenuItems("Account Limits"), "Account Limits", cssProp, expValue,
				expColor);
	}
	...
	public void handSymbolHighlightedFeatureControls(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSubMenuItems("Feature Controls"), "Feature Controls", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedCardBlackList(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSubMenuItems("Card Blacklist"), "Card Blacklist", cssProp, expValue,
				expColor);
	}

	public void handSymbolHighlightedPushNotifications(String cssProp, String expValue, String expColor) {
		commonfunctions.verifyChangedColor(getSubMenuItems("Push Notifications"), "Push Notifications", cssProp,
				expValue, expColor);
	}
