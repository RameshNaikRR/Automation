...
import coyni.admin.Paymentspopups.AddAdditionalDocumentPopup;
import coyni.admin.Paymentspopups.AddRevisionTaskPopup;
import coyni.admin.Paymentspopups.ApproveCasePopup;
import coyni.admin.Paymentspopups.DeclineApplicationPopup;
...
//		action.moveByOffset(0, 550).build().perform();
	...
	public AddAdditionalDocumentPopup addAdditionalDocumentsPopup() {
		return new AddAdditionalDocumentPopup();
	}
...
//	}
	...
	public DeclineApplicationPopup declineCasePopup() {
		return new DeclineApplicationPopup();
	}
