...
import coyni.admin.Paymentspopups.SaveChangePopUp;
...
public class PreferencesandControlsComponent extends BrowserFunctions {
	...
	private By btnPay = By
			.xpath("//span[text()='Pay']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')]");
	private By btnRequest = By.xpath(
			"//span[text()='Request']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')]");
	private By btnWithDrawalExternalBankAccount = By.xpath(
			"(//span[text()='External Bank Account']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')])[1]");
	private By btnWithDrawalInstantPay = By.xpath(
			"(//span[text()='Instant Pay']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')])[1]");
	private By btnWithDrawalGiftCard = By.xpath(
			"(//span[text()='Gift Card']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')])[1]");
	private By btnBuyTokensCreditCard = By.xpath(
			"(//span[text()='Credit Card']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')])[1]");
	private By btnBuyTokensDebitCard = By.xpath(
			"(//span[text()='Debit Card']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')])[1]");
	private By btnBuyTokensexternalBankAccount = By.xpath(
			"(//span[text()='External Bank Account']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')])[2]");
	private By btnPaymentCreditCard = By.xpath(
			"(//span[text()='Credit Card']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')])[2]");
	private By btnPaymentDebitCard = By.xpath(
			"(//span[text()='Debit Card']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')])[2]");
	private By btnPaymentExternalBankAccount = By.xpath(
			"(//span[text()='External Bank Account']/..//div[contains(@class,'react-toggle react-toggle--checked toggle-blue')])[3]");
