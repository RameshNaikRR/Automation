...
public class WithdrawCompleted extends BrowserFunctions{
	private By heading = By.xpath("");
	private By description = By.xpath("");
	private By transactionMessage = By.xpath("");
	...
	public void getTransactionMessage() {
		String str = getText(transactionMessage, "Transaction Message");
