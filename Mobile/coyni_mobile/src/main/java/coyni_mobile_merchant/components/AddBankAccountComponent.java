...
//	private By  = MobileBy.xpath("//*[contains(@resource-id,'descriptionTV')]");
...
/*here confirmation screen not coming every time so, to handle this we are using get element list but 
here explicitly wait is not working. so, to get accurate results we are using static wait
*/		
		Thread.sleep(1500);
