...
public class TeamPage extends MobileFunctions {
	...
	private By btnSelectPendingStatusTeamMember = MobileBy.xpath("(//*[contains(@resource-id,'addTeamMemberL')]//*[contains(@text,'Pending')])[1]");
	private By btnSelectResendInvitationStatusTeamMember = MobileBy.xpath("(//*[contains(@resource-id,'addTeamMemberL')]//*[contains(@text,'Resend')])[1]");
