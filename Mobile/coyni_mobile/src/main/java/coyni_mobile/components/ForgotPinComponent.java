...
public class ForgotPinComponent extends MobileFunctions{
	...
	private By lblEmailFiled = MobileBy.xpath("//*[contains(@resource-id,'etlEmail')]");
	...
	public void verifyEmailVerificationHeading(String expEmailVerificationHeading) {
		new CommonFunctions().verifyLabelText(lblEmailVericationHeading, "Email Verification Heading", expEmailVerificationHeading);
	}
	public void verifyEmailVerificationDescription(String expEmailVerificationDescrp) {
		new CommonFunctions().verifyLabelText(lblEmailVerificationDescrp, "Email Verification Descrption", expEmailVerificationDescrp);
	}
